...
**Due Monday, November 8 at the end of class through Github**
...
means_ci(x)   # should get [1] 0.46814336 0.02225103

means_ci(x, y, type="two.means")   # should get [1] -0.06933551 -0.53662437

x2 <- c(x, NA)
y2 <- c(y, NA)
means_ci(x2, y2, type="two.means")  # should get [1] NA NA
means_ci(x2, y2, type="two.means", na.rm=TRUE)   # should get [1] -0.06933551 -0.53662437
```
